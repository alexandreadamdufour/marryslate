...
export function SeatingTableNode({ table, onUnassign, onDelete }: Props) {
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "group relative flex select-none flex-col items-center justify-center gap-1 border-2 bg-card shadow-sm",
    ...
    >
      ...
      <button
        ...
        className="absolute -right-2 -top-2 z-10 hidden h-5 w-5 items-center justify-center rounded-full bg-destructive text-destructive-foreground shadow-sm group-hover:flex"
